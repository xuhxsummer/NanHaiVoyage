...
public final class Catalog {
    ...
    public static final float WORLD_W = 19200f;
    public static final float WORLD_H = 14400f;

    public static final int WORLD_VERSION = 3;
    public static final float LAYOUT_SCALE = 4f;
    public static final int DAILY_LOGIN_SILVER = 200;
    ...
    // 0.28.11: quadruple the 0.28.9 layout; land and ship sizes remain in local units.
    public static final float[] PORT_X = scaledLayout(new float[]{
    ...
    public static final float[] PORT_Y = scaledLayout(new float[]{
    ...
    public static final float[] ISLAND_X = scaledLayout(new float[]{
            3538f, 2800f, 2000f, 4450f, 3350f, 2300f, 3700f, 3023f, 3392f, 2793f, 2050f, 2504f, 2748f
    });
    public static final float[] ISLAND_Y = scaledLayout(new float[]{
            2478f, 1700f, 1200f, 2400f, 1300f, 1070f, 1450f, 2332f, 2237f, 2523f, 2450f, 2707f, 2228f
    });

    private static float[] scaledLayout(float[] coordinates) {
        for (int i=0;i<coordinates.length;i++) coordinates[i]*=LAYOUT_SCALE;
        return coordinates;
    }

...
public final class Catalog {
    ...
    public static final float WORLD_W = 9600f;
    public static final float WORLD_H = 7200f;
    ...
    // 0.28.10: double the 0.28.9 layout; land and ship sizes remain in local units.
    public static final float[] PORT_X = doubled(new float[]{
    ...
    public static final float[] PORT_Y = doubled(new float[]{
    ...
    public static final float[] ISLAND_X = doubled(new float[]{
            3538f, 2800f, 2000f, 4450f, 3350f, 2300f, 3700f, 3023f, 3392f, 2793f, 2050f, 2504f, 2748f
    });
    public static final float[] ISLAND_Y = doubled(new float[]{
            2478f, 1700f, 1200f, 2400f, 1300f, 1070f, 1450f, 2332f, 2237f, 2523f, 2450f, 2707f, 2228f
    });

    private static float[] doubled(float[] coordinates) {
        for (int i=0;i<coordinates.length;i++) coordinates[i]*=2f;
        return coordinates;
    }
